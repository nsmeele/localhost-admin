...
<form method="post" id="new-projects">
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <input type="radio" name="type" id="type-folder" value="folder" checked>
                <label for="type-folder">Folder</label>
                <br>
                <input type="radio" name="type" id="type-file" value="file">
        ...
        <tr>
            ...
            <td colspan="5">
                <button type="submit" name="submit" class="btn btn-primary"><i class="fas fa-plus-circle"></i>&nbsp;Add
                    new project
                </button>
            </td>
        </tr>
